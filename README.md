...
Building NSAttributedString is so difficult that it requires us to remember attribute names and types. When you build  NSAttributedString with StringStylizer, There is no need to remember them.
